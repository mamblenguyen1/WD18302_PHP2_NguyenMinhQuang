...
if(isset($_POST['change'])){
    ...
    $errors = $UserValidator->validateChangePassOne();
    $data[] = $_POST;
...
<div class="content-wrapper">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Đổi mật khẩu khách hàng :  <?= $data['user']['user_name']?></h4>
                ...
                <form class="forms-sample" method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" disabled   class="form-control" id="exampleInputName1" value="<?=$data['user']['user_name']?>"  placeholder="Nhập tên tài khoản">
                        <input type="hidden"  name="user_name" class="form-control" id="exampleInputName1" value="<?=$data['user']['user_name']?>"  placeholder="Nhập tên tài khoản">
