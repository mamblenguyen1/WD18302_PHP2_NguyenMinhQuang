...
if (isset($_POST['addInfo'])) {
    ...
    echo '<script> window.location.href="/?pages=InvoiceController/addProduct/&id=' . $invoice_id . '"</script>';
}
                        ...
                        ?>
                            <div class="product" id="product<?= $index ?>">
                                ...
                                <div class="product-info">
                                    ...
                                    <p data-unit-price="<?= $InvoiceDetail['product_price'] ?>" id="price<?= $index ?>">Tổng: <?= number_format($InvoiceDetail['product_price']) ?> VNĐ</p>
                                </div>
                                <div class="quantity">
