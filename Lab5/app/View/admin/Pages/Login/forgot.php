...
<main class="page-content">
    ...
    <form id="loginForm" class="contact-form" method="post">
        ...
        <div class="form-field">
            <label for="surname">Địa chỉ email</label>
            <input type="text" id="surname" name="user_email" />
        </div>
        <div>
            <input type="submit" name="forgot" class="btn" />
        </div>
        <a href="/?pages=LoginController/logIn">Đăng nhập</a>
        <a style="margin-left: 30px;" href="/?pages=LoginController/register">Đăng kí</a>
    </form>
</main>
